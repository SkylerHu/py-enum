...
class ClassWithAbstractVirtualProperty(six.with_metaclass(abc.ABCMeta)):
    @DynamicClassAttribute
    @abc.abstractmethod
    def color(self):
        pass
...
class ClassWithPropertyAbstractVirtual(six.with_metaclass(abc.ABCMeta)):
    @abc.abstractmethod
    @DynamicClassAttribute
    def color(self):
        pass
